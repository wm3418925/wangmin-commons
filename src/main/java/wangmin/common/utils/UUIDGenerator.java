/*
 * Copyright (c) 2003, 2011, Oracle and/or its affiliates. All rights reserved. ORACLE PROPRIETARY/CONFIDENTIAL. Use is subject to license terms.
 */
 ...
 *
 * <p>
 * There exist different variants of these global identifiers. The methods of this class are for manipulating the Leach-Salz variant, although the constructors
 ...
 *
 * <p>
 * The variant field contains a value which identifies the layout of the {@code UUID}. The bit layout described above is valid only for a {@code
 ...
 * UUID}. There are four different basic types of UUIDs: time-based, DCE security, name-based, and randomly generated UUIDs. These types have a version value of
 * 1, 2, 3 and 4, respectively.
 *
 * <p>
 * For more information including algorithms used to create {@code UUID}s, see <a href="http://www.ietf.org/rfc/rfc4122.txt"> <i>RFC&nbsp;4122: A Universally
 * Unique IDentifier (UUID) URN Namespace</i></a>, section 4.2 &quot;Algorithms for Creating a Time-Based UUID&quot;.
 *
 * @since 1.5
 */
public final class UUIDGenerator implements java.io.Serializable, Comparable<UUIDGenerator> {
    ...
    /*
     * The random number generator used by this class to create random based UUIDs. In a holder class to defer initialization until needed.
     */
     ...
     */
    private UUIDGenerator(byte[] data) {
        long msb = 0;
        long lsb = 0;
     ...
     */
    public UUIDGenerator(long mostSigBits, long leastSigBits) {
    ...
    public static UUIDGenerator randomUUID() {
        ...
        return new UUIDGenerator(randomBytes);
    }


    /**
     * 
     * @return A randomly generated {@code UUID} String
     */
     ...
     */
    public static UUIDGenerator nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
        ...
        return new UUIDGenerator(md5Bytes);
    }
     ...
     *
     */
    public static UUIDGenerator fromString(String name) {
        ...
        return new UUIDGenerator(mostSigBits, leastSigBits);
    }
     ...
     *
     * <p>
     * The 60 bit timestamp value is constructed from the time_low, time_mid, and time_hi fields of this {@code UUID}. The resulting timestamp is measured in
     * 100-nanosecond units since midnight, October 15, 1582 UTC.
     *
     * <p>
     * The timestamp value is only meaningful in a time-based UUID, which has version type 1. If this {@code UUID} is not a time-based UUID then this method
     ...
     *
     * <p>
     * The {@code clockSequence} value is only meaningful in a time-based UUID, which has version type 1. If this UUID is not a time-based UUID then this method
     * throws UnsupportedOperationException.
     *
     ...
     * true} if and only if the argument is not {@code null}, is a {@code UUID} object, has the same variant, and contains the same value, bit for bit, as this
     * {@code UUID}.
     *
    ...
    public boolean equals(Object obj) {
        if ((null == obj) || (obj.getClass() != UUIDGenerator.class))
            return false;
        UUIDGenerator id = (UUIDGenerator) obj;
     ...
     *
     */
    public int compareTo(UUIDGenerator val) {
