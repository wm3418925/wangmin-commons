...
@ContextConfiguration(locations = "classpath*:test-redis/normal/redis-normal.xml")
public class TestRedisNormal {
    private final static Logger logger = LoggerFactory.getLogger(TestRedisNormal.class);
